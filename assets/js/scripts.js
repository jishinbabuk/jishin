$(document).ready(function() {
    ...
    if ($("#gmap").length) {
        ...
        function init() {
            var mapOptions = {
                ...
                center: new google.maps.LatLng(24.478543396098143, 54.354690471114914), // New York
                styles: [{
                        "stylers": [{
            ...
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(24.478543396098143, 54.354690471114914),
                map: map,
                title: 'Address',
    ...
    $('.alphabetsOnly').bind('keyup paste', function() {
        this.value = this.value.replace(/[^a-z A-Z\.]/g, '');
    });
...
$(".book-now-scroll").click(function(e) {
    e.preventDefault();
    $('html, body').animate({
        scrollTop: $("#single-sidebar").offset().top - 10
    }, 1000);
});